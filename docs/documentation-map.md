...
| Deployment         | `Containerfile`, `serve.js`, `deploy/quadlets/web.container`, `scripts/deploy-*`      | `docs/deployment/`, `docs/operations/deploy-apply.md`, `ADR-028` | deploy/preflight/smoke tests                       |
