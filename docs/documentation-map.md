...
| Postgres and Drizzle                 | `src/lib/server/db/`, `drizzle/`, `drizzle.config.ts`, `src/routes/readyz/+server.ts`                                                                                                   | `docs/database/README.md`, `ADR-004`                                                         | `bun run check:db`, unit tests, bootstrap smoke                            |
...
| Runtime automation outbox            | `src/lib/server/automation/`, `scripts/automation-worker.ts`, `automation_events`, `automation_dead_letters`                                                                            | `docs/automations/`, `docs/forms/README.md`, `ADR-015`                                       | automation unit tests, `bun run forms:check`                               |
...
| Deployment and runtime               | `Containerfile`, `serve.js`, `deploy/`, `.github/workflows/ci.yml`                                                                                                                      | `docs/deployment/`, `ADR-007`, `ADR-018`, `ADR-019`                                          | CI image build, Trivy, container smoke, deploy preflight                   |
