...
| Deployment and runtime               | `.dockerignore`, `Containerfile`, `serve.js`, `deploy/`, `scripts/deploy-preflight.ts`, `scripts/deploy-smoke.ts`, `scripts/lib/quadlets.ts`, `.github/workflows/ci.yml`                                                                                                                                                           | `docs/deployment/`, `ADR-007`, `ADR-018`, `ADR-019`, `ADR-024`, `ADR-027`                                                                             | CI image build, Trivy, container smoke, deploy preflight, deploy smoke                                  |
