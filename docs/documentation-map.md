...
| Business forms and scaffolds         | `src/routes/contact/`, `src/lib/forms/`, `src/lib/server/forms/`, `scripts/scaffold-form.ts`, `scripts/lib/scaffold.ts`, `scripts/form-ops.ts`                                                                                                                                                                                                                       | `docs/forms/README.md`, `docs/design-system/forms-guide.md`, `ADR-024`                                                                                                                        | `bun run forms:check`, scaffold/form-ops/schema/unit/e2e tests                                          |
| Runtime automation outbox            | `src/lib/server/automation/`, `scripts/automation-worker.ts`, `scripts/form-ops.ts`, `deploy/quadlets/worker.container`, `automation_events`, `automation_dead_letters`                                                                                                                                                                                              | `docs/automations/`, `docs/automations/n8n-workflow-contract.md`, `docs/forms/README.md`, `docs/deployment/`, `ADR-015`, `ADR-024`, `ADR-027`                                                 | automation unit tests, `bun run forms:check`, deploy preflight                                          |
...
| Deployment and runtime               | `.dockerignore`, `Containerfile`, `serve.js`, `deploy/`, `scripts/deploy-apply.ts`, `scripts/lib/deploy-engine.ts`, `scripts/deploy-preflight.ts`, `scripts/deploy-smoke.ts`, `scripts/rollback.ts`, `scripts/lib/rollback-engine.ts`, `scripts/lib/quadlets.ts`, `.github/workflows/ci.yml`                                                                         | `docs/deployment/`, `docs/operations/deploy-apply.md`, `docs/operations/smoke.md`, `docs/operations/rollback.md`, `ADR-007`, `ADR-018`, `ADR-019`, `ADR-024`, `ADR-027`, `ADR-028`, `ADR-029` | CI image build, Trivy, container smoke, deploy apply/preflight/smoke, rollback and deploy unit tests    |
| Ops status ledger                    | `scripts/lib/ops-status.ts`, `scripts/lib/release-state.ts`, `scripts/lib/quadlet-image.ts`, `~/.local/state/<project>/ops/`                                                                                                                                                                                                                                         | `docs/operations/ops-status-ledger.md`, `ADR-025`                                                                                                                                             | ops-status, release-state, and quadlet-image unit tests                                                 |
...
| Backups and restore (PITR + legacy)  | `deploy/Containerfile.postgres`, `scripts/backup-base.sh`, `scripts/backup-wal-check.sh`, `scripts/backup-pitr-check.sh`, `scripts/backup-restore-drill.ts`, `scripts/backup-*.sh`, `scripts/restore-db.sh`, `scripts/backup-check.ts`, `deploy/systemd/backup-base.*`, `deploy/systemd/backup-check.*`, `deploy/systemd/backup.*`, `deploy/systemd/restore-drill.*` | `docs/operations/backups.md`, `docs/operations/restore.md`, `docs/operations/restore-drill.md`, `docs/operations/architecture.md`, `docs/privacy/data-retention.md`, `ADR-022`, `ADR-023`     | backup unit tests, `bun run backup:pitr:check`, `bun run backup:restore:drill`, `bun run backup:verify` |
| Locked site Quadlet set              | `scripts/lib/quadlets.ts`, `deploy/quadlets/web.container`, `deploy/quadlets/postgres.container`, `deploy/quadlets/worker.container`                                                                                                                                                                                                                                 | `docs/deployment/`, `docs/operations/architecture.md`, `ADR-024`, `ADR-027`                                                                                                                   | `tests/unit/quadlets.test.ts`, deploy preflight                                                         |
