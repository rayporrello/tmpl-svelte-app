...
| Runtime automation outbox            | `src/lib/server/automation/`, `scripts/automation-worker.ts`, `scripts/form-ops.ts`, `deploy/systemd/automation-worker.*`, `automation_events`, `automation_dead_letters`               | `docs/automations/`, `docs/forms/README.md`, `docs/deployment/`, `ADR-015`                   | automation unit tests, `bun run forms:check`, deploy preflight             |
