...
<figure>
  <CmsImage src="/uploads/team.jpg" alt="The Acme team at our 2026 offsite" width={1200} height={800} />
  <figcaption>Our team, April 2026</figcaption>
</figure>
```
...
The `width` attr values above are for `<enhanced:img>` (Tier 1). For `<CmsImage>` (Tier 2, no srcset), use the *display* size your design shows — the browser loads that one file for all screens.
